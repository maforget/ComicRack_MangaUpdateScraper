    ...
    for book in books:
        ...
        if pSeries and pSeries == book.Series:
            ...
            if data:
                ...
                if DEBUG_LEVEL >= 1: print("--> id: " + unicode(cID))
                if DEBUG_LEVEL >= 1: print("--> series: " + unicode(serie))
                if DEBUG_LEVEL >= 1: print("--> url: " + unicode(cURL))
                if DEBUG_LEVEL >= 1: print("--> genre: " + unicode(cGenre))
                if DEBUG_LEVEL >= 1: print("--> description: " + unicode(cDescription))
                ...
                if GET_INFO_FROM_SERIES_PAGE:
                    ...
                    if series_info and len(series_info) > 0:
                        ...
                        if DEBUG_LEVEL >= 1: print("--> Author: " + unicode(cAuthor))
